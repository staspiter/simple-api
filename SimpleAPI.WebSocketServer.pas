unit SimpleAPI.WebSocketServer;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Hash := TIdEncoderMIME.EncodeBytes(HashSHA1.HashString(Trim(arr[SecWebSocketKeyLine].Split([': '])[1]) + '258EAFA5-E914-47DA-95CA-C5AB0DC85B11'));
